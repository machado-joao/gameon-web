      ...
      {cartItems.length === 0 ? (
        <div className="text-center card p-6 w-full mb-5">
          <div className="flex items-center flex-col">
            ...
            <Link href="/">
              <button className="primary-button bg-white text-xl border border-solid border-gray-300 hover:bg-blue-700">
                Voltar
              </button>
            </Link>
          </div>
                    ...
                    <tr key={item.slug} className="border-t border-t-black">
                      <td>
                        <Link href={`/product/${item.slug}`}>
                          <div className="flex cursor-pointer justify-center text-center items-center">
                            <Image
                              alt={item.name}
                              src={item.image}
              ...
              <ul className="card bg-white p-5">
                  ...
                  <div className="pb-3 text-xl">
                    ...
                    {cartItems
                      .reduce(
                        (a, c) =>
                          a +
                          c.quantity * (c.price - (c.price * c.discount) / 100),
                        0
                      )
                      .toFixed(2)}
                  </div>
                ...
                <li>
                  <button
                    ...
                    className="primary-button w-full border border-solid border-gray-300 hover:bg-blue-700"
                  >
                    Confirmar
                  </button>
                </li>
